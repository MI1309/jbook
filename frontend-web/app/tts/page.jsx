...
export default function CrosswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] transition-colors duration-300 font-sans text-gray-900 dark:text-gray-100 selection:bg-red-200">
      <Navbar />
      <div className="max-w-6xl mx-auto py-8 px-4">
        <header className="mb-8 text-center">
          ...
          <p className="text-gray-400 font-bold text-lg">Latih kosa kata bahasa Jepang JLPT kamu di sini.</p>
        </header>
