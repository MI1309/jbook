...
export default function KanjiDetailModal({ id, onClose }) {
    ...
    if (!kanji) {
        return (
            <div className="fixed inset-0 z-[100] bg-white dark:bg-background overflow-y-auto transition-colors duration-300">
                <div className="p-6">
                    <button onClick={handleClose} className="mb-4 text-red-600 dark:text-red-400 font-bold transition-colors">← Kembali</button>
